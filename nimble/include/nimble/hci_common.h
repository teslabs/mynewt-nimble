...
/* LMP features, page 0 (Core Vol 2, Part C, 3.3) */
#define BLE_HCI_LMP_FEAT_3_SLOT_PACKETS                   (UINT64_C(1) << 0)
#define BLE_HCI_LMP_FEAT_5_SLOT_PACKETS                   (UINT64_C(1) << 1)
#define BLE_HCI_LMP_FEAT_ENCRYPTION                       (UINT64_C(1) << 2)
#define BLE_HCI_LMP_FEAT_SLOT_OFFSET                      (UINT64_C(1) << 3)
#define BLE_HCI_LMP_FEAT_TIMING_ACCURACY                  (UINT64_C(1) << 4)
#define BLE_HCI_LMP_FEAT_ROLE_SWITCH                      (UINT64_C(1) << 5)
#define BLE_HCI_LMP_FEAT_HOLD_MODE                        (UINT64_C(1) << 6)
#define BLE_HCI_LMP_FEAT_SNIFF_MODE                       (UINT64_C(1) << 7)
#define BLE_HCI_LMP_FEAT_POWER_CONTROL_REQUESTS           (UINT64_C(1) << 9)
#define BLE_HCI_LMP_FEAT_CQDDR                            (UINT64_C(1) << 10)
#define BLE_HCI_LMP_FEAT_SCO_LINK                         (UINT64_C(1) << 11)
#define BLE_HCI_LMP_FEAT_HV2_PACKETS                      (UINT64_C(1) << 12)
#define BLE_HCI_LMP_FEAT_HV3_PACKETS                      (UINT64_C(1) << 13)
#define BLE_HCI_LMP_FEAT_ULAW_SYNC_DATA                   (UINT64_C(1) << 14)
#define BLE_HCI_LMP_FEAT_ALAW_SYNC_DATA                   (UINT64_C(1) << 15)
#define BLE_HCI_LMP_FEAT_CVSD_SYNC_DATA                   (UINT64_C(1) << 16)
#define BLE_HCI_LMP_FEAT_PAGING_PARAM_NEGOTIATION         (UINT64_C(1) << 17)
#define BLE_HCI_LMP_FEAT_POWER_CONTROL                    (UINT64_C(1) << 18)
#define BLE_HCI_LMP_FEAT_TRANSPARENT_SYNC_DATA            (UINT64_C(1) << 19)
#define BLE_HCI_LMP_FEAT_FLOW_CONTROL_LAG_LSB             (UINT64_C(1) << 20)
#define BLE_HCI_LMP_FEAT_FLOW_CONTROL_LAG_MID             (UINT64_C(1) << 21)
#define BLE_HCI_LMP_FEAT_FLOW_CONTROL_LAG_MSB             (UINT64_C(1) << 22)
#define BLE_HCI_LMP_FEAT_BROADCAST_ENCRYPTION             (UINT64_C(1) << 23)
#define BLE_HCI_LMP_FEAT_EDR_ACL_2M                       (UINT64_C(1) << 25)
#define BLE_HCI_LMP_FEAT_EDR_ACL_3M                       (UINT64_C(1) << 26)
#define BLE_HCI_LMP_FEAT_ENHANCED_INQUIRY_SCAN            (UINT64_C(1) << 27)
#define BLE_HCI_LMP_FEAT_INTERLACED_INQUIRY_SCAN          (UINT64_C(1) << 28)
#define BLE_HCI_LMP_FEAT_INTERLACED_PAGE_SCAN             (UINT64_C(1) << 29)
#define BLE_HCI_LMP_FEAT_RSSI_WITH_INQUIRY_RESULTS        (UINT64_C(1) << 30)
#define BLE_HCI_LMP_FEAT_EV3_PACKETS                      (UINT64_C(1) << 31)
#define BLE_HCI_LMP_FEAT_EV4_PACKETS                      (UINT64_C(1) << 32)
#define BLE_HCI_LMP_FEAT_EV5_PACKETS                      (UINT64_C(1) << 33)
#define BLE_HCI_LMP_FEAT_AFH_CAPABLE_PERIPHERAL           (UINT64_C(1) << 35)
#define BLE_HCI_LMP_FEAT_AFH_CLASSIFICATION_PERIPHERAL    (UINT64_C(1) << 36)
#define BLE_HCI_LMP_FEAT_BR_EDR_NOT_SUPPORTED             (UINT64_C(1) << 37)
#define BLE_HCI_LMP_FEAT_LE_SUPPORTED_CONTROLLER          (UINT64_C(1) << 38)
#define BLE_HCI_LMP_FEAT_3_SLOT_EDR_ACL_PACKETS           (UINT64_C(1) << 39)
#define BLE_HCI_LMP_FEAT_5_SLOT_EDR_ACL_PACKETS           (UINT64_C(1) << 40)
#define BLE_HCI_LMP_FEAT_SNIFF_SUBRATING                  (UINT64_C(1) << 41)
#define BLE_HCI_LMP_FEAT_PAUSE_ENCRYPTION                 (UINT64_C(1) << 42)
#define BLE_HCI_LMP_FEAT_AFH_CAPABLE_CENTRAL              (UINT64_C(1) << 43)
#define BLE_HCI_LMP_FEAT_AFH_CLASSIFICATION_CENTRAL       (UINT64_C(1) << 44)
#define BLE_HCI_LMP_FEAT_EDR_ESCO_2M                      (UINT64_C(1) << 45)
#define BLE_HCI_LMP_FEAT_EDR_ESCO_3M                      (UINT64_C(1) << 46)
#define BLE_HCI_LMP_FEAT_3_SLOT_EDR_ESCO_PACKETS          (UINT64_C(1) << 47)
#define BLE_HCI_LMP_FEAT_EXTENDED_INQUIRY_RESPONSE        (UINT64_C(1) << 48)
#define BLE_HCI_LMP_FEAT_SIMUL_LE_BR_EDR_CONTROLLER       (UINT64_C(1) << 49)
#define BLE_HCI_LMP_FEAT_SECURE_SIMPLE_PAIRING_CONTROLLER (UINT64_C(1) << 51)
#define BLE_HCI_LMP_FEAT_ENCAPSULATED_PDU                 (UINT64_C(1) << 52)
#define BLE_HCI_LMP_FEAT_ERRONEOUS_DATA_REPORTING         (UINT64_C(1) << 53)
#define BLE_HCI_LMP_FEAT_NON_FLUSHABLE_PBF                (UINT64_C(1) << 54)
#define BLE_HCI_LMP_FEAT_LSTO_CHANGED_EVENT               (UINT64_C(1) << 56)
#define BLE_HCI_LMP_FEAT_VARIABLE_INQUIRY_TX_POWER        (UINT64_C(1) << 57)
#define BLE_HCI_LMP_FEAT_ENHANCED_POWER_CONTROL           (UINT64_C(1) << 58)
#define BLE_HCI_LMP_FEAT_EXTENDED_FEATURES                (UINT64_C(1) << 63)
